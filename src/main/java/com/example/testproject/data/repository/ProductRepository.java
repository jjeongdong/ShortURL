...
public interface ProductRepository extends JpaRepository<Product, String> {
    ...
    // 값 개수 제한
    List<Product> findFirst7ByName(String name);
    ...
    // And, Or
    List<Product> findByIdOrName(String id, String name);
    ...
    @Query(value = "SELECT * FROM product WHERE price",
            ...
            nativeQuery = true)
    List<Product> findByPriceWithParameterPaging2(Pageable pageable);
}